import { CancellationToken, ClientCapabilities, Definition, Disposable, DocumentSelector, ImplementationOptions, ImplementationRegistrationOptions, Position, ServerCapabilities, TextDocument } from 'vscode-languageserver-protocol';
