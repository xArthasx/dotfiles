...
export declare type TextChangedEvent = 'TextChanged';
...
declare class Events {
    ...
    on(event: TextChangedEvent, handler: (bufnr: number, changedtick: number) => Result, thisArg?: any, disposables?: Disposable[]): Disposable;
