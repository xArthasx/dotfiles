...
export declare abstract class BaseLanguageClient {
    ...
    private _trace;
    private _tracer;
    constructor(id: string, name: string, clientOptionsFunc: () => LanguageClientOptions);
    private get state();
    get id(): string;
    get name(): string;
